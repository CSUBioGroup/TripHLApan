...
def independent_test_distribute2(independent_data_file_path, model_save_dir_name, out_file_path):

    MODEL_SAVE_PATH = '../models/' + model_save_dir_name + '/'

    independent_pep_seq_list, independent_allele1_seq_list, independent_allele2_seq_list = load_independent_data_from_file_for_test(independent_data_file_path)
    ...
    for item in latest_files:
        ...
        independent_dataset = MyDataSet_distribute_independent_test(independent_pep_seq_list, independent_allele1_seq_list, independent_allele2_seq_list)
        ...
        for idx in range(len(predic_keys)):
            ...
            dict_key_prob_tmp[predic_keys[idx] + str(idx)] = pred_prob[idx][0]
 ...
 # configue
from model import *
independent_data_file_path = '../for_prediction/test.txt'
# independent_data_file_path = '../for_prediction/'

model_save_dir_name = 'model' # select models
out_file_path = '../for_prediction/test_output.txt'
independent_test_distribute2(independent_data_file_path, model_save_dir_name, out_file_path)
# configue
